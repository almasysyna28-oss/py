...
def download_from_youtube(url: str, quality: str = DEFAULT_QUALITY) -> str | None:
    ...
    ydl_opts = {
        ...
        # این خط رو از کامنت خارج کنید (باید در همون مرورگر لاگین یوتیوب باشید):
...
def handle_message(chat_id: int, text: str):
    ...
    if not filepath:
        send_message(chat_id, "❌ دانلود ویدیو ناموفق بود. ممکنه لینک خصوصی، حذف‌شده یا محدود باشه.")
        return
